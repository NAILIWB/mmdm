...
public class PermissaoAcesso extends JApplet {
    ...
    private String cabecalho[]={"ID Permissão","Tipo Permissão", "Ativo"};
                            ...
                            getContentPane().setLayout(null);
                            {
                                    ...
                                    jTabbedPane1.setBorder(new SoftBevelBorder(BevelBorder.LOWERED, null, null, null, null));
                                    {
                                            ...
                                            }
                                            {
                                                    ...
                                                    jPanel3.setBounds(17, 17, 424, 103);
                                                    ...
                                                    }
                                                    {
                                                    	...
                                                    	jComboBox1.setToolTipText("Selecione o perfil desejado.");
                                                    ...
                                                    }
                                                    {
                                                    	jLabel2 = new JLabel();
                                                    	jPanel3.add(jLabel2);
                                                    	jLabel2.setText("Tipo Permissão");
                                                    }
                                                    {
                                                    	jTextField1 = new JTextField();
                                                    	jPanel3.add(jTextField1);
                                                    	jTextField1.setToolTipText("Informe a descrição da permissão conforme o perfil selecionado.");
                                                    ...
                                                    }
                                                    {
                                                    	...
                                                    	jComboBox2.setToolTipText("Selecione 'sim' ou 'não' para ativar a permissão.");
